...
hidden if the `swiftmc_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `swiftmc_DEVELOPER_MODE` to the configure
...
Runs the executable target `swiftmc_exe`.
